...
public class CircleImageView extends ImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currMode = a.hasValue(R.styleable.CircleImageView_type) ? a.getInt(R.styleable.CircleImageView_type, MODE_NONE) : MODE_NONE;
        currRound = a.hasValue(R.styleable.CircleImageView_radius) ? a.getDimensionPixelSize(R.styleable.CircleImageView_radius, currRound) : currRound;
        a.recycle();
    }
